...
public class EditaOrcamento extends javax.swing.JFrame {
    ...
    public EditaOrcamento(OrcamentoDTO orcamento, Principal formPrincipal, Consulta c) {
        this.consulta = c;
        ...
        textCliente.setText(clienteDAO.puxaNomeCliente(orcamento.getCod_cliente()));
        mostraMoto(motoDAO.puxaMoto(orcamento.getCod_cliente()));
        criaTabela();
        lista = o.puxaLista(orcamento.getCod_Orcamento());
        for (String s : lista) {
            String[] parte = s.split(";");
            modelo.addRow(parte);
        }
        carrega();
        textTotal.setText(String.valueOf(orcamento.getTotal()));
        total = orcamento.getTotal();
        codCliente = orcamento.getCod_cliente();
        codMoto = orcamento.getCod_moto();
    }
    ...
    private void btnProcurarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcurarClienteActionPerformed
        consulta = new Consulta(Estados.modoConsCliente, null, consulta, true, this, null);
        ...
        if (textCliente.getText().isEmpty()) {
            ...
            if (modelo.getRowCount() == 0) {
                ...
                if (!naoTemItens) {
                    ...
                    if (o.alteraOrcamento(orcamento)) {
                        Mensagens.msgInfo("Orçamento alterado com sucesso.");
                    }
                    consulta.telaFechando("EditaOrcamento");
                    if (consulta != null) {
    ...
    private void novoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_novoActionPerformed
        SelecaoItem s = new SelecaoItem(this, true, this, null);
        s.setVisible(true);
        if (s.ePdto()) {
            colocaNaTabela(true);
        } else {
